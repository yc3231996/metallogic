...
import { fetchWorkspaceInfo } from '@/service'
...
const Welcome: FC<IWelcomeProps> = ({
  ...
  useEffect(() => {
    if(savedInputs) {
      const workspace = Object.entries(savedInputs).find(([key]) => key.toLowerCase() === 'workspace')?.[1];
      if (workspace && typeof workspace === 'string') {
        fetchWorkspaceInfo(workspace).then(setWorkspaceInfo).catch(console.error);
      }
    }
  }, [savedInputs]);
  ...
  return (
    <div className='relative mobile:min-h-[48px] tablet:min-h-[64px]'>
      ...
      <div className='mx-auto pc:w-[1200px] max-w-full mobile:w-full px-3.5'>
        {/*  Has't set inputs  */}
        {
          !hasSetInputs && (
